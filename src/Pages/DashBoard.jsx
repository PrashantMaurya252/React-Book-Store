...
function DashBoard() {
  return (
    <div className='mt-10'>
        <div className='flex flex-col md:flex-row md:9/12 w-9/1 justify-between items-center bg-gradient-to-r from-yellow-800 to-yellow-200 m-1 ml-8 mr-8 gap-10 rounded-lg p-5 h-1/4 '>
        ...
        <div className='flex flex-col w-9/1 justify-between items-center bg-gradient-to-r from-yellow-800 to-yellow-200 m-1 rounded-lg p-5 md:flex-row-reverse ml-8 mr-8 '> 
